...
<tr><td>Attached file:</td><td><input type="file" name="photo" value="<%= u.getPhoto()%>"/></td></tr>
<tr><td>Title:</td><td><input type="text" name="title" value="<%= u.getTitle()%>"/></td></tr>
<tr><td>Writer:</td><td><input type="text" name="writer" value="<%= u.getWriter()%>"/></td></tr>
<tr><td>Content:</td><td><textarea cols="50" rows="5" name="content" value="<%= u.getContent()%>"></textarea></td></tr>
